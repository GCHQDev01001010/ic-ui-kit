// IcCardVerticalMultiplePage displays multiple vertical cards for the purpose of performance testing of the IcCardVertical component.
...
const Card = () => (
  <IcCardVertical
    ...
    expandable
    clickable
    style={{ marginBottom: "var(--ic-space-md)" }}
  >
...
const IcCardVerticalMultiplePage: React.FC<PageProps> = ({ theme }) => {
  return (
    <IcTheme id="theme-wrapper" theme={theme}>
      <div style={{ padding: "var(--ic-space-md)" }}>
        <IcTypography variant="subtitle-small">
          <h1>Vertical Card Multiple Page</h1>
        </IcTypography>
        <div
          style={{
            display: "grid",
...
export default IcCardVerticalMultiplePage;
